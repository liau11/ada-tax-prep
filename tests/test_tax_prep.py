...
from ada_tax_prep.income_tax import (
    calculate_tax_2020,
    calculate_deducted_income_2020,
    calculate_tax_liability_2020,
    TaxPayer,
)
...
def few_valid_deductions():
    return {"charity": 5000, "mortgage": 5000, "child": 5000}
...
def test_taxpayer_receiving_a_return_gets_a_return(all_valid_deductions):
    taxpayer = TaxPayer(
        withholdings=3000, income=50000, deductions=all_valid_deductions
    )
...
def test_taxpayer_owing_tax_has_negative_return(few_valid_deductions):
    taxpayer = TaxPayer(
        withholdings=3000, income=50000, deductions=few_valid_deductions
    )
